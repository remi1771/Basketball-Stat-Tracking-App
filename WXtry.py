...
class MainFrame(wx.Frame):
    def __init__(self, parent):
        ...
        EasyButton(self, 'NEW', 3)
        EasyButton(self, 'SETTINGS', 4)
        EasyButton(self, 'SHOT', 5, enabled=False)
        EasyButton(self, 'PASSING', 6, enabled=False)
        EasyButton(self, 'TURNOVER', 7, enabled=False)
        EasyButton(self, 'FOUL', 8, enabled=False)
